...
process(){
    ...
    SPACE_FILTER_PATTERN='s#[[:space:]]##g'
    ...
    grep -vE $IGNORE_PATTERN $GFWLIST_FILE | $SED_ERES $SPACE_FILTER_PATTERN | $SED_ERES $HEAD_FILTER_PATTERN | $SED_ERES $TAIL_FILTER_PATTERN | grep -E $DOMAIN_PATTERN | $SED_ERES $HANDLE_WILDCARD_PATTERN > $DOMAIN_TEMP_FILE
